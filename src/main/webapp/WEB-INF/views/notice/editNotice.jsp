...
<head>
	...
	<jsp:include page="../header.jsp" />
	    ...
	    <div class="new-post-container">
	        <h2>글 수정</h2>
	        <form class="new-post-form" action="/notice/editNotice.do" method="POST">
	        	<input type="hidden" name="notice_id" value="${editNotice.notice_id}">
	        	<input type="hidden" name="member_name" value="<sec:authentication property='principal.username'/>">
	            <div class="form-group">
	                <label for="post-title">제목</label>
	                <input type="text" id="post-title" name="title" required maxlength="100" value="${editNotice.title}"> 
	                <span class="character-count">0 / 100</span>
	            </div>
	            <div class="form-group">
	                <label for="post-content">내용</label>
	                <textarea id="post-content" name="content" required maxlength="1000">${editNotice.content}</textarea>
